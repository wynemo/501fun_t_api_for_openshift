...
BITLY_BASE_URL = "https://api-ssl.bit.ly/"
...
class Api(object):
    ...
    def __init__(self, login, apikey, timeout=3):
        self.login = login
        self.apikey = apikey
    ...
    def _fetchUrl(self,url):
        ...
        url_data = self._urllib.urlopen(url,timeout=self.timeout).read()
        return url_data    
...
if __name__ == '__main__':
    ...
    a=Api("user_name","key",4)
    long=a.expand(' http://j.mp/HJCqPU')
